...
public class Divisiones_Tech {
    ...
    public Divisiones_Tech(String nombre, String campo, String tech_desarrollada, int año_creacion) {
        this.nombre = nombre;
        this.campo = campo;
    ...
    public String toString() {
        return "Divisiones_Tech{" + "nombre=" + nombre + ", campo=" + campo + ", tech_desarrollada=" + tech_desarrollada + ", a\u00f1o_creacion=" + año_creacion + '}';
    }
